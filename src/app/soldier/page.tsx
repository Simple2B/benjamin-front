...
export default function Page() {
  ...
  const deathInfo:IInfo[] =[
    ...
    },
    {
      ...
      criteriaValue: 'Succumbed to scrub typhus at the 2nd Station Hospital in Nadzab'
    },
    {
    ...
    {
      criteriaName: 'Initial burial ',
      criteriaValue: 'Manila American Cemetery (Plot A, Row 7, Grave 79), Taguig City, Philippines'
    },
  ];
  ...
  return (
    <div>
      <div className='flex flex-col justify-center items-center mx-7 gap-4 my-4'>
        ...
        <ClosebleInfo heading='LIFE' component={
          <SoldierCardBlockInfo info={lifeInfo} />
        }/> 
        <ClosebleInfo heading='SERVICE' component={
          <>
            <SoldierCardBlockInfo info={serviceInfo} />
            <SoldierAdditionalImage imageUrl='#' imageDescription='Jewish Serviceman’s card' />
          </>
        }/> 
        <ClosebleInfo heading='DEATH' component={
          <>
            <SoldierCardBlockInfo info={deathInfo} />
            <SoldierAdditionalImage imageUrl='#' imageDescription='Killed In Action (KIA) Telegram' />
          </>
        }/> 
        <ClosebleInfo heading='CHANGE CEREMONY' component={<SoldierAdditionalVideo videoUrl='-' videoDescription='Replacement ceremony video' />}/> 
      </div>
